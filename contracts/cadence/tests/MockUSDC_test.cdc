...
access(all) fun testMintTokens() {
    ...
    let mintTxCode = Test.readFile("../transactions/mock-usdc/MintMockUSDC.cdc")
    ...
    // Verify the balance
    let getBalanceScriptCode = Test.readFile("../scripts/mock-usdc/GetBalance.cdc")
    ...
    // Verify total supply
    let totalSupplyScriptCode = Test.readFile("../scripts/mock-usdc/GetTotalSupply.cdc")
...
access(all) fun testTransferTokens() {
    ...
    let transferTxCode = Test.readFile("../transactions/mock-usdc/TransferMockUSDC.cdc")
